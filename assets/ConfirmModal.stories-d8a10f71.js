...
fermentum augue.`,re={title:"organisms/Modal/ConfirmModal",component:s},a={render:r=>{const i=_(),{search:t}=f();return e.jsxs(e.Fragment,{children:[e.jsx(d,{onClick:()=>{i("/?tab=1")},children:"Open"}),e.jsx(s,{...r,opened:t.includes("?tab="),onClose:()=>i("/"),confirmButtonProps:{children:"Confirm"},children:z})]})}};var l,u,c;a.parameters={...a.parameters,docs:{...(l=a.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: args => {
...
}`,...(c=(u=a.parameters)==null?void 0:u.docs)==null?void 0:c.source}}};const ie=["Default"];export{a as Default,ie as __namedExportsOrder,re as default};
//# sourceMappingURL=ConfirmModal.stories-d8a10f71.js.map
