...
fermentum augue.`,ae={title:"organisms/Modal/ConfirmModal",component:s},a={render:i=>{const r=_(),{search:o}=f();return e.jsxs(e.Fragment,{children:[e.jsx(u,{onClick:()=>{r("/?tab=1")},children:"Open"}),e.jsx(s,{...i,opened:o.includes("?tab="),onClose:()=>r("/"),confirmButtonProps:{children:"Confirm"},children:g})]})}};var m,c,d;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: args => {
...
}`,...(d=(c=a.parameters)==null?void 0:c.docs)==null?void 0:d.source}}};const se=["Default"];export{a as Default,se as __namedExportsOrder,ae as default};
//# sourceMappingURL=ConfirmModal.stories-be2726ff.js.map
