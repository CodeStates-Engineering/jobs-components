export const LONG_TEXT =
  'aurora sunrise eunoia vanilla iris adorable kitten laptop lucid sunrise shine banana adorable moonlight melody haze sunrise vanilla girlish blossom';

export const VERY_LONG_TEXT = `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur
...
export const OPTIONS = Array.from({ length: 100 }, (_, index) => ({
