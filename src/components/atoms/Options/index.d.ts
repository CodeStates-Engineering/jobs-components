...
export declare const Options: <_Option extends Option<ValidOptionValue> = Option<ValidOptionValue>, _Multiple extends boolean = false>({ opened, options, multiple, value, onSelect, onKeyDown, float, className, }: OptionsProps<_Option, _Multiple>) => JSX.Element;
export {};
