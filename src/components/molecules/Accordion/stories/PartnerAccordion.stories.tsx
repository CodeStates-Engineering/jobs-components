...
import type { PartnerAccordionProps } from '../PartnerAccordion';

export default {
  title: 'molecules/Accordion/PartnerAccordion',
  component: PartnerAccordion,
} as ComponentMeta<typeof PartnerAccordion>;

const AccordionStory: ComponentStory<typeof PartnerAccordion> = (args) => (
  <div
    style={{
      height: '50vh',
      width: '300px',
...
const defaultArgs: PartnerAccordionProps = {
  title: 'Lorem ipsum dolor sit amet',
  children: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur
