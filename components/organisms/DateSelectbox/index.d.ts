...
export declare const DateSelectbox: <TDateType extends DateType = "single">({ value, type, onChange, placeholder, disabled, onFocus, id, onClick, ref, label, validation, className, inputStyle, labelStyle, description, }: DateSelectboxProps<TDateType>) => JSX.Element;
export {};
